...
<div class="card">
    ...
    <ul class="nav nav-tabs" role="tablist" id="relationship-tabs">
        ...
        <li class="nav-item">
            <a class="nav-link" href="#class_kontens" role="tab" data-toggle="tab">
    ...
    <div class="tab-content">
        ...
        <div class="tab-pane" role="tabpanel" id="class_kontens">
            @includeIf('admin.schoolClasses.relationships.classKonten', ['kontens' => $schoolClass->classKontens])
        </div>
    </div>
</div>
