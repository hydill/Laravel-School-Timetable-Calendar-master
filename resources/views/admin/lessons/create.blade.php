        ...
        <div class="card-body">
            <form method="POST" action="{{ route('admin.lessons.store') }}" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('weekday') ? 'is-invalid' : '' }}" type="number"
                        name="weekday" id="weekday" value="{{ old('weekday') }}" step="1" required>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('konten') ? 'is-invalid' : '' }}" type="text"
                        name="konten" id="konten" value="{{ old('konten') }}">
